                ...
                if(argDiscovery.test(args[i])){
                    ...
                    switch(identifier){
                        ...
                        case 'assets_index_name':
                            ...
                            break
                        case 'auth_uuid':
                            if (this.authUser.uuid.includes('offline-')) {
                                // Gera um UUID válido para não crashar o Minecraft 1.21
                                val = '00000000-0000-0000-0000-000000000000'.replace(/[0]/g, (c, i) => 
                                    (i < 8 || i > 8) ? Math.floor(Math.random() * 16).toString(16) : '-'
                                ).substring(0, 36);
                            } else {
        ...
        for(let i=0; i<mcArgs.length; ++i){
            if(argDiscovery.test(mcArgs[i])){
                ...
                switch(identifier){
                    ...
                    case 'auth_uuid':
                        if (this.authUser.uuid.includes('offline-')) {
                            // Gera um UUID válido baseado no nick 'teste' (ou qualquer outro)
                            // Isso garante que o tamanho seja SEMPRE 36 caracteres.
                            val = '00000000-0000-0000-0000-000000000000'.replace(/[0]/g, (c, i) => 
                                (i < 8 || i > 8) ? Math.floor(Math.random() * 16).toString(16) : '-'
                            ).substring(0, 36);
                        } else {
